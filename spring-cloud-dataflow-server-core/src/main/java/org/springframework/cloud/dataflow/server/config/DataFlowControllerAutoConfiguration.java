...
public class DataFlowControllerAutoConfiguration {
	...
	@Bean
	public RuntimeModulesController runtimeModulesController(AppDeployer appDeployer) {
		return new RuntimeModulesController(Collections.singleton(appDeployer));
	}

	@Bean
	public AppInstanceController appInstanceController(AppDeployer appDeployer) {
		return new AppInstanceController(Collections.singleton(appDeployer));
	}
	...
	@Bean
	public ModuleController moduleController(ArtifactRegistry registry) {
		return new ModuleController(registry);
	}
